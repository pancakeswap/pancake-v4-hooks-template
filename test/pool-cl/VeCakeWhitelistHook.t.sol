...
import {VeCakeWhitelistHook} from "../../src/pool-cl/VeCakeWhitelistHook.sol";
import {CLTestUtils} from "./utils/CLTestUtils.sol";
import {CLPoolParametersHelper} from "@pancakeswap/v4-core/src/pool-cl/libraries/CLPoolParametersHelper.sol";
import {PoolIdLibrary} from "@pancakeswap/v4-core/src/types/PoolId.sol";
import {ICLSwapRouterBase} from "pancake-v4-periphery/src/pool-cl/interfaces/ICLSwapRouterBase.sol";

contract VeCakeWhitelistHookTest is Test, CLTestUtils {
    using PoolIdLibrary for PoolKey;
    using CLPoolParametersHelper for bytes32;

    VeCakeWhitelistHook hook;
    Currency currency0;
    Currency currency1;
    PoolKey key;
    ...
    function setUp() public {
        ...
        hook = new VeCakeWhitelistHook(poolManager, address(veCake));
    ...
    function testNonVeCakeHolder_beforePublicTradeStartTime() public {
        vm.expectRevert(VeCakeWhitelistHook.PoolNotOpenForPublicTradeYet.selector);
        _swap();
    }

    function testNonVeCakeHolder_afterPublicTradeStartTime() public {
        /// proceed to public trade start time
        vm.warp(hook.publicTradeStartTime());
